 ...
 */
@Data
@ApiModel(description = "元数据字段创建请求")
public class FieldCreateRequest {

    @ApiModelProperty(value = "字段序号", required = true, example = "1")
    @NotNull(message = "字段序号不能为空")
    @Min(value = 1, message = "字段序号必须大于0")
    private Integer fieldOrder;

    @ApiModelProperty(value = "字段名称", required = true, example = "user_id")
    ...
    @ApiModelProperty(value = "字段类型", required = true, example = "BIGINT")
